...
our %config = (
  ...
  CPPFLAGS => [ "-DANDROID -D__ANDROID_API__=21 -I/home/levcsi/.buildozer/android/platform/android-ndk-r19c/sysroot/usr/include/arm-linux-androideabi -I/home/levcsi/projects/kivy/dig_rec_2/.buildozer/android/platform/build-armeabi-v7a/build/python-installs/dig_rec/include/python3.8" ],
  CPPINCLUDES => [  ],
  ...
  LDFLAGS => [ "  -L/home/levcsi/projects/kivy/dig_rec_2/.buildozer/android/platform/build-armeabi-v7a/build/libs_collections/dig_rec/armeabi-v7a" ],
  LDLIBS => [ "-lm" ],
  PERL => "/usr/bin/perl",
  RANLIB => ":",
  RC => "windres",
